export const sourceRegistry = [
  {
    ...
    claim: "2026 入学招生说明显示：085400 电子信息专业计划招生 583 名、拟接收推免生 255 名；01-04 方向统考科目相同，均为 101 思想政治理论、201 英语一、301 数学一、408 计算机学科专业基础，并统一划定统考分数线、统一排名、择优录取。04 方向含未来技术学院成像科学中心代招名额。该结论只能作为当前备考基准，不能替代 2028 入学当年公告。",
  ...
  },
  {
    level: "待官方发布",
    title: "2028 入学招生信息核验",
    claim: "截至 2026-05-31，2028 入学对应招生简章、专业目录、方向、考试科目、报名和网上确认要求尚未作为本系统的已核验事实；2027 年 9-10 月必须以研招网、北京大学研究生招生网和学院官网重新核验。",
...
export const executionBoundaries = [
  ...
  ["渐进时长", "2026 年 6 月从工作日约 90 分钟、周末约 150 分钟起步；7 月约 120/210 分钟，8 月约 150/240 分钟；9 月起进入第一轮主干强度。"],
